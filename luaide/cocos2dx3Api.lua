...
function cc.Terrain:convertToTerrainSpace(Vec2_worldSpace) end
--[[
...
function cc.AsyncTaskPool:destoryInstance() end
--[[
...
--[[
	...
	@return [luaIde#cc.Action]   A new action that performs the exactly the reverse action.
	@js NA
]]
...
function cc.PolygonInfo:getTriaglesCount() end
--[[
	get vertex count
...
function cc.PolygonInfo:setTriangles(TrianglesCommand_Triangles_triangles) end
...
function cc.Twirl:initWithDuration(float_duration,const_Size_gridSize,Vec2_position,unsigned_int_twirls,float_amplitude) end
--[[
	@brief Get the amplitude rate of the effect.
	@return float   Return the amplitude rate of the effect.
]]
...
function cc.Physics3DConstraint:setOverrideNumSolverIterations(int_overideNumIterations) end
--[[
	get constraint type
...
function sp.SkeletonAnimation:initialize() end 
...
--[[
	...
	@param itemAnchorPoint Specifies an anchor point of each item for position to calculate distance.
	@return [luaIde#ccui.Widget]   A item instance if list view is not empty. Otherwise, returns null.
]]
...
--[[
	...
	@return bool   True if initialize scucess, false otherwise.
]]
...
--[[
	...
	@param fontName Content font name.
	@param fontSize Content font size.
	@return [luaIde#ccui.RichElementText]   RichElementText instance.
]]
...
--[[
	...
	@return [luaIde#cc.Vec2]   Percet (x,y) in Vec2.
]]
